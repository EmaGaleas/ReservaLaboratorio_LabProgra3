...
private:
    ...
    std::string labSolicitado, clase, motivo, perfil, nombreI, numeroI, correoI, infoGrupo, equipo, fecha,repe, cant,horaI,horaF;
    int repetir,cantidad,horaInicio, horaFin;
    Solicitante *s;
    lista <Solicitante*> SS;

public:

    cframe(QWidget *parent = nullptr);
    ~cframe();
    bool CargarSoli(string Nombre);
